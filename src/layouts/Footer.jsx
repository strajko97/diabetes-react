...
function Footer() {
  return (
    ...
    <div className="footer container-fluid p-3" style={{ backgroundImage: 'linear-gradient(rgb(111, 212, 158), rgb(0, 65, 31))' }}>
      <div className="row">
        <div className="col-lg-3 col-md-10 col-sm-10 mx-auto my-lg-2 text-center">
          <div className="footer-site-name">Tanjirići Zdravići</div>
      ...
      <div className="row">
        <div className="container-fluid text-center">
          <div className="footer-subCategory">
            <h4>
              <strong>Copyright &copy; 2024; Designed by Tea&Strajko</strong>
            </h4>
          </div>
        </div>
      </div>
